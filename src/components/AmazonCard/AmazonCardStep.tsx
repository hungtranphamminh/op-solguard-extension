...
import arrowdetail from '@assets/images/Amazon/detail.svg'
    ...
    <div className="flex justify-start items-start gap-[8px] h-full w-full">
                    ...
                    <>
                      <div className="text-base font-bold flex w-full items-center justify-between pb-4">
                        ...
                        <div className="relative mt-3">
                          <button className="flex items-center justify-center gap-1 text-[9px] font-bold text-[#140E24] w-11 bg-[#FFF] px-[5px] py-[1px] text-center relative z-10">
                            <p>Detail</p>
      ...
      {step == 4 && (
        <div className="flex flex-col items-start bg-[rgba(25,57,67,0.05)] w-full  border-[0.5px] border-solid border-[rgba(165,210,200,0.25)] p-3">
          ...
          {/* Step content */}
          <div className="flex justify-center items-center w-full gap-2.5 mt-4">
            {stepLoading[3] ? <Loader size={4} /> : <img src={Check} alt="check icon" width={12} />}

            <p className="text-[11px] leading-[13.2px] tracking-[-0.25] font-normal text-[#CECBCF] ">
              {stepLoading[3]
